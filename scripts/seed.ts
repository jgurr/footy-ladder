 ...
 *
 * Note: This requires POSTGRES_URL to be set in environment
 */

import { initializeDatabase, getGamesBySeason, getLadder } from "../src/lib/queries";
...
async function main() {
  ...
  // 2025 verification
  const ladder = await getLadder(2025, 27);
